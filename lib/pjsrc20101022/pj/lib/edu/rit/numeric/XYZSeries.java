...
// Exported helper classes.
	...
	/**
	 * Class XYZSeries.RobustStats holds the medians and mean absolute
	 * deviations of an {@linkplain XYZSeries}.
	 *
	 * @author  Alan Kaminsky
	 * @version 11-Oct-2010
	 */
	public static class RobustStats
		...
		/**
		 * Median of the series' Y values. Let the length of the series be
		 * <I>n</I>. Let the series' Y values be sorted into ascending order. If
		 * <I>n</I> is even, the median is
		 * (<I>y</I><SUB><I>n</I>/2&minus;1</SUB>&nbsp;+&nbsp;<I>y</I><SUB><I>n</I>/2</SUB>)/2.
		 * If <I>n</I> is odd, the median is
		 * <I>y</I><SUB>(<I>n</I>&minus;1)/2</SUB>.
		 */
		...
		/**
		 * Median of the series' Z values. Let the length of the series be
		 * <I>n</I>. Let the series' Z values be sorted into ascending order. If
		 * <I>n</I> is even, the median is
		 * (<I>z</I><SUB><I>n</I>/2&minus;1</SUB>&nbsp;+&nbsp;<I>z</I><SUB><I>n</I>/2</SUB>)/2.
		 * If <I>n</I> is odd, the median is
		 * <I>z</I><SUB>(<I>n</I>&minus;1)/2</SUB>.
		 */
		public final double medianZ;

		/**
		 * Mean absolute deviation of the series' Z values. The absolute
		 * deviation of one value <I>z</I> is
		 * |<I>z</I>&nbsp;&minus;&nbsp;<I>medianZ</I>|. The mean absolute
		 * deviation is the mean of all the Z values' absolute deviations.
		 */
		public final double meanAbsDevZ;

		/**
		 * Construct a new XYZSeries.RobustStats object.
		 */
		private RobustStats
			(double medianX,
			 double meanAbsDevX,
			...
			this.meanAbsDevY = meanAbsDevY;
			this.medianZ = medianZ;
			this.meanAbsDevZ = meanAbsDevZ;
			}
		}
...
// Exported operations.
	...
	public Stats stats()
		{
		Series.Stats xStats = xSeries().stats();
		Series.Stats yStats = ySeries().stats();
		Series.Stats zStats = zSeries().stats();
		return new XYZSeries.Stats
			(xStats.meanX, xStats.varX, xStats.stddevX,
			 yStats.meanX, yStats.varX, yStats.stddevX,
			 zStats.meanX, zStats.varX, zStats.stddevX);
		}
	...
	public RobustStats robustStats()
		{
		Series.RobustStats xStats = xSeries().robustStats();
		Series.RobustStats yStats = ySeries().robustStats();
		Series.RobustStats zStats = zSeries().robustStats();
		return new XYZSeries.RobustStats
			(xStats.medianX, xStats.meanAbsDevX,
			 yStats.medianX, yStats.meanAbsDevX,
			 zStats.medianX, zStats.meanAbsDevX);
		}
